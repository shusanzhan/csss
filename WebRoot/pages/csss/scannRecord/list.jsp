...
<div class="location">
	...
	<a href="javascript:void(-1);" onclick="">扫描记录管理</a>
</div>
 <!--location end-->
<div class="line"></div>
<div class="listOperate">
	<div class="operate">
		...
		<a class="but butCancle" href="javascript:void(-1);" onclick="$.utile.deleteIds('${ctx }/scannRecord/delete','searchPageForm')">删除</a>
   </div>
  	<div class="seracrhOperate">
  		<form name="searchPageForm" id="searchPageForm" action="${ctx}/scannRecord/queryList" method="post">
...
<table width="100%"  cellpadding="0" cellspacing="0" class="mainTable" border="0">
	...
	<c:forEach var="scannRecord" items="${page.result }">
		<tr height="32" align="center">
			...
			<td>
				<a href="#" class="aedit"
				onclick="$.utile.deleteById('${ctx }/scannRecord/delete?dbids=${scannRecord.dbid}')">删除</a>
		</tr>
	</c:forEach>
</table>
</c:if>
