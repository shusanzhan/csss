...
public class CityShop implements Serializable
{
  ...
  public CityShop(String name, String provice, String city, String areaStr, String address, String pointx, String pointy, String note, Date createDate, Date modifyDate, Integer num, Set csssStaffs)
  {
    this.name = name;
