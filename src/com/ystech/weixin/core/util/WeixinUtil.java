...
public class WeixinUtil {
    ...
    * @return
     */
    public static WeixinAccesstoken getAccessToken(WeixinAccesstokenManageImpl weixinAccesstokenManageImpl,String appid,String appsecret) {
    	// 第三方用户唯一凭证
//        String appid = bundle.getString("appId");
//        // 第三方用户唯一凭证密钥
//        String appsecret = bundle.getString("appSecret");
        
    	WeixinAccesstoken accessTocken = getRealAccessToken(weixinAccesstokenManageImpl);
    	try{
            	...
            	if(end.getTime()-accessTocken.getAddtime().getTime()>(accessTocken.getExpiresIb()*250)){
                     ...
                     if (null != jsonObject) {
                         try {
                             ...
                             weixinAccesstokenManageImpl.save(accessTocken);
                             return accessTocken;
                         } catch (Exception e) {	
                             // 获取token失败
                 ...
                 if (null != jsonObject) {
                     try {
                         ...
                         saveAccessToken(accessToken,weixinAccesstokenManageImpl);
                     } catch (Exception e) {
                         accessToken = null;
                         // 获取token失败
                         String wrongMessage = "获取token失败 errcode:{} errmsg:{}"+jsonObject.getInt("errcode")+jsonObject.getString("errmsg");
     ...
     * @return
     */
    public static String getTicket(WeixinAccesstokenManageImpl accessTokenYwManageImpl,String appid,String appsecret){
    	WeixinAccesstoken accessToken = getAccessToken(accessTokenYwManageImpl,appid,appsecret);
     ...
     * @return
     */
    public static WeixinAccesstoken getRealAccessToken(WeixinAccesstokenManageImpl accessTokenYwManageImpl){
        List<WeixinAccesstoken> accessTockenList = accessTokenYwManageImpl.executeSql("select * from Weixin_AccessToken",null);
