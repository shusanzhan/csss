...
public class WeixinAccesstokenManageImpl extends HibernateEntityDao<WeixinAccesstoken>{
	...
	public void updateSql(WeixinAccesstoken accessTocken) {
		String sql = "update weixin_accesstoken set access_token='"+accessTocken.getAccessToken()+"',expires_ib="+accessTocken.getExpiresIb()+",addtime=now() where dbid='"+accessTocken.getDbid()+"'";
    	executeSql(sql);
	}
