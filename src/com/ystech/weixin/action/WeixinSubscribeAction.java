...
public class WeixinSubscribeAction extends BaseController {
	...
	public String queryList() throws Exception {
		...
		try{
			 ...
			 Page<WeixinSubscribe> page= weixinSubscribeManageImpl.pagedQuerySql(pageNo, pageSize, WeixinSubscribe.class, "select * from Weixin_Subscribe where accountid=?", new Object[]{weixinAccount.getDbid()+""});
	...
	public String add() throws Exception {
		...
		try{
			 WeixinAccount weixinAccount = SecurityUserHolder.getWeixinAccount();
			List<WeixinSubscribe> weixinSubscribes = weixinSubscribeManageImpl.findBy("accountid", weixinAccount.getDbid()+"");
	...
	public void save() throws Exception {
		...
		try{
			Integer dbid = weixinSubscribe.getDbid();
			 WeixinAccount weixinAccount = SecurityUserHolder.getWeixinAccount();
			 weixinSubscribe.setAccountid(weixinAccount.getDbid()+"");
