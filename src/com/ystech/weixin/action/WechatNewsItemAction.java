...
public class WechatNewsItemAction extends BaseController{
	...
	public String queryList() throws Exception {
		...
		try{
			...
			List<WechatNewsTemplate> wechatNewsTemplates = wechatNewsTemplateManageImpl.find("from WechatNewsTemplate where accountid=?", new Object[]{weixinAccount.getDbid()+""});
	...
	public void save() throws Exception {
		...
		try{
			...
			if(wechatTemplateDbid>0){
				...
				wechatNewsTemplate.setAccountId(accountId);
